 ...
 */
// server: postRouter.get('/:postId', retrievePost);
 ...
 */
// server: userRouter.get('/:username/posts/:offset', retrievePosts);
 ...
 */
// server: postRouter.post('/:postId/vote', requireAuth, votePost);
 ...
 */
// server: postRouter.post('/', postLimiter, requireAuth, upload, createPost);
 ...
 */
// server: postRouter.delete('/:postId', requireAuth, deletePost);
 ...
 * @return {object}
 */
// server: userRouter.post('/:postId/bookmark', requireAuth, bookmarkPost);
 ...
 */
// server: postRouter.get("/filters", (req, res) => {res.send({ filters });});
 ...
 */
//  server: postRouter.get('/suggested/:offset', requireAuth, retrieveSuggestedPosts);
 ...
 * @returns {array} Array of posts
 */
// server: postRouter.get('/hashtag/:hashtag/:offset', requireAuth, retrieveHashtagPosts);
