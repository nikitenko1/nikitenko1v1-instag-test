 ...
 */
// server: userRouter.get('/:username', optionalAuth, retrieveUser);
 ...
 */
// server: userRouter.post('/:userId/follow', requireAuth, followUser);
 ...
 * @param {string} authToken A user's auth token
 */
// server: userRouter.get('/:userId/:offset/following', requireAuth, retrieveFollowing);
 ...
 * @param {string} authToken A user's auth token
 */
// server: userRouter.get('/:userId/:offset/followers', requireAuth, retrieveFollowers);
