 ...
 */
// server: userRouter.get('/:username/:offset/search', searchUsers);
 ...
 */
// server: userRouter.put('/confirm', requireAuth, confirmUser);
 ...
 */
// server: userRouter.put('/avatar', requireAuth, multer({})
 ...
 * @param {string} authToken A user's auth token
 */
// server: userRouter.delete('/avatar', requireAuth, removeAvatar);
 ...
 */
// server: userRouter.put('/', requireAuth, updateProfile);
 ...
 */
// server: userRouter.get('/suggested/:max?', requireAuth, retrieveSuggestedUsers);
