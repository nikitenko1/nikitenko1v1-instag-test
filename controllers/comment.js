...
exports.deleteComment = async (req, res, next) => {
  ...
  try {
    ...
    // mongoosejs.com api: res.deletedCount; // Number of documents removed
...
exports.voteCommentReply = async (req, res, next) => {
  const { commentReplyId } = req.params;
  const user = res.locals.user;
...
exports.retrieveCommentReplies = async (req, res, next) => {
...
exports.retrieveComments = async (req, res, next) => {
