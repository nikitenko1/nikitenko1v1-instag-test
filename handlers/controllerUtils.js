...
module.exports.sendEmail = async (to, subject, message) => {
  ...
  await transporter.sendMail({
    from: '"KyivApp Support" <support@kyivapp.net>',
    to,
    subject,
    html: message,
  });
...
module.exports.sendConfirmationEmail = async (
  ...
  const message = ` "Confirm your Kyiv App account",
       "<div style =" +
          "width:100%; height:100%;  " +
          "><h1 style=" +
          "font-weight:500>Hey, " +
          ${username} +
          "<br>Welcome to Kyiv App</h1><h1>Thanks for Signing up on our app</h1><h3>Your Code for verification is : " +
           ${process.env.HOME_URL}/confirm/${confirmationToken}  +
          " </h3></div><p>If this request is not made by you kindly ignore this mail.</p><p>Regards, <strong>Kyiv App(Owner)</strong></p>",
      `;
  try {
